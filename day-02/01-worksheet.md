# Lab 2 — AI Opportunity Discovery Sprint

**Thời lượng:** 4 giờ (240 phút)
**Hình thức:** Cá nhân + nhóm (4-5 người)
**Chuẩn bị:** Giấy A3/A4, bút màu (đỏ, xanh), điện thoại/laptop
...
```
Phase 0  WORKED EXAMPLE                     15 min   Giảng viên
Phase 1  SCAN — Tìm kiếm cơ hội             20 min   Cá nhân → Nhóm
Phase 2  QUICK-ASSESS — Round 1              40 min   Cá nhân → Nhóm
         ─── Break ───                       10 min
Phase 3  PITCH-CHALLENGE-VOTE               30 min   Nhóm
Phase 4  DEEP-DIVE — Round 2                 85 min   Nhóm
         ─── Break ───                       10 min
Phase 5  EVALUATE                            20 min   Nhóm
Phase 6  REFLECTION                          10 min   Cá nhân
                                       ────────────
                                       Tổng: 240 min
```

> **Vì sao 2 rounds?** Round 1 bạn nhìn nhanh nhiều bài toán (breadth). Round 2 bạn đào sâu 1 bài toán (depth). Đây là pattern Double Diamond trong Design Thinking — mở rộng rồi thu hẹp, lặp lại 2 lần.
...
# Phase 1 — SCAN: Tìm kiếm cơ hội (20 min)

## Mục tiêu
Liệt kê càng nhiều bài toán tiềm năng càng tốt. **Không filter, không đánh giá** — chỉ liệt kê.
...
Giải thích ngắn (1-2 câu — vì sao tick bên đó?):
_______________________________________________

**3. UX Check:** "User recover thế nào khi AI sai?"

> **🤖 AI Tip — Phase 4d: Digitize Future-State Flow**
> **Dùng AI để:** Chuyển future-state flow vẽ tay thành diagram (giống Phase 4a). **Tự điền AI Suitability + Underspecification tables TRƯỚC, AI sau.**
> **Tool gợi ý:** Giống Phase 4a — Claude, ChatGPT, Gemini (hoặc Antigravity nếu bạn có)
> **Example prompt:** "Đây là future-state workflow có AI [paste ảnh]. Chuyển thành flowchart diagram. Đánh dấu: bước AI xử lý (🔵), bước human quyết định (🟢), boundary AI không được làm (🔴), và fallback khi AI sai (➡️)."
> **Lưu ý:** Tables phân tích (AI Suitability, Underspecification) phải do bạn tự suy nghĩ — đây là phần tư duy quan trọng nhất.

### Vẽ Future-State Flow

Vẽ kế bên current-state flow. Dùng ký hiệu:

- 🔵 **AI xử lý** — bước AI đảm nhận
- 🟢 **Human quyết định** — bước người review/approve
- 🔴 **Boundary** — AI không được làm
- ➡️ **Fallback** — nếu AI sai → chuyển về đâu?

### AI Fit Decision

Chốt (dùng thang 3 mức từ slide):

- [ ] No AI / Rule-workflow đủ
- [ ] LLM Feature (AI hỗ trợ 1-2 bước cụ thể)
- [ ] Agent (AI tự động nhiều bước, có planning)

**Summary:**
Nhóm cho rằng AI **{có thể / không thể}** giải quyết bài toán _______________,
vì _______________________________________________

### Underspecification Check

Điều gì trong bài toán đang bị NGẦM HIỂU mà chưa nói rõ?
...
> *Ví dụ: Nếu "thời gian phản hồi chấp nhận được" không rõ → AI có thể trả lời chậm 30s mà user bỏ đi → Hỏi user: "Bạn chờ được bao lâu trước khi chuyển sang cách khác?"*
...
> Phase này không dùng AI — nhóm tự chịu trách nhiệm quyết định.

## Bước 5.1 — Feasibility & Go/Not Yet/No-Go (20 min)

### AI Readiness Checklist (từ slide)

| # | Câu hỏi | Yes/No | Ghi chú |
|---|---------|--------|---------|
| 1 | Có data/input đủ chất lượng và số lượng? | | |
| 2 | Có metric rõ ràng để đo thành/bại? | | |
| 3 | Sai thì hậu quả có chấp nhận được không? | | |
| 4 | User sẵn sàng dùng AI trong workflow này không? | | |
| 5 | Có resource (người, tiền, thời gian) để maintain không? | | |

**Dưới 3 YES → cân nhắc Not Yet hoặc No-Go.**

### Optimization Check

AI solution có thể mang lại:
- {lợi ích 1} _______________________________________________
- {lợi ích 2} _______________________________________________

Nhưng nếu AI optimize sai hướng thì sao?
- {hành vi không mong muốn 1} _______________________________________________
- {hành vi không mong muốn 2} _______________________________________________

> *Ví dụ: AI recommend sản phẩm → lợi ích: user tìm được đồ phù hợp nhanh hơn. Nhưng nếu AI chỉ recommend đồ có margin cao? User mua nhưng không hài lòng → churn.*

### Quyết định

- [ ] **Go** — đủ điều kiện để build/pilot
- [ ] **Not Yet** — có tiềm năng nhưng thiếu data/resource/clarity
- [ ] **No-Go** — không phù hợp cho AI, rule/manual tốt hơn

**Justify (3-5 dòng):**

**Nếu Not Yet — cần validate gì tiếp?**

> **Nhớ:** "Not Yet" không phải thất bại. "No-Go" có justify tốt vẫn điểm cao.
...
| Câu hỏi | Trả lời |
|----------|---------|
| AI giúp gì hôm nay? (research? brainstorm? draft?) | |
| AI sai hoặc hời hợt ở đâu? | |
| Bạn/nhóm phải sửa gì bằng tay? | |
| Prompt hay nhất hôm nay? | |

## Reflection cá nhân

- Bài học lớn nhất hôm nay:
- Điều bất ngờ nhất:
- Nếu có thêm 1 giờ, sẽ làm gì:
- AI giúp nhiều nhất ở phase nào? Vì sao?
- AI sai hoặc không hữu ích ở đâu?
- Nếu làm lại, bạn sẽ dùng AI khác đi ở bước nào?
...
**📚 Đọc thêm:** [Google PAIR Guidebook](https://pair.withgoogle.com/guidebook/) — framework thiết kế AI product có người dùng ở trung tâm.
